...
//     console.log('BankTransferTab mounted', { 
//         hasPropTransfers: !!propTransfers, 
//         propTransfersCount: propTransfers?.length 
//     });

//     // Use props if provided, otherwise fetch locally
//     useEffect(() => {
//         console.log('BankTransferTab useEffect triggered', { 
//             propTransfers, 
//             propLoading 
//         });
...
//             console.log('Agent transfers:', agentTransfers);
...
//             console.log('Transfers with details:', transfersWithDetails);
...
//         } catch (err) {
//             console.error('Error in fetchBankTransfers:', err);
//             setError(`Failed to load bank transfers: ${err.message}`);
//         } finally {
//             setIsLoading(false);
//         }
//     };
...
//     const calculateStats = (transferData) => {
//         console.log('Calculating stats for:', transferData);
...
//     const handleViewTransfer = (transfer) => {
//         console.log('View transfer clicked:', transfer);
...
//             console.log('Created bookingForModal:', bookingForModal);
...
//             console.log('Setting selectedTransfer:', selectedData);
//             setSelectedTransfer(selectedData);
//             setShowTransferModal(true);
//         } catch (err) {
//             console.error('Error in handleViewTransfer:', err);
//             alert('Error opening transfer details. Please try again.');
//         }
//     };
...
//     // If there's an error, show error UI instead of white screen
//     if (error) {
//         return (
...
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
//                     </svg>
//                     <h3 className="text-xl font-bold text-gray-800 mb-2">Error Loading Transfers</h3>
...
const BankTransferTab = ({ 
    ...
    const handleViewTransfer = (transfer) => {
        ...
        try {
            ...
            console.error('Error in handleViewTransfer:', err);
            if (showToast) {
                showToast('Error opening transfer details. Please try again.', 'error');
            } else {
                alert('Error opening transfer details. Please try again.');
            }
        }
    ...
    const handleStatusUpdate = (newStatus) => {
        ...
        if (showToast) {
            if (newStatus === 'Verified') {
                showToast('Bank transfer verified successfully! Payment has been processed.', 'success');
            } else if (newStatus === 'Rejected') {
                showToast('Bank transfer rejected.', 'warning');
            }
        }
