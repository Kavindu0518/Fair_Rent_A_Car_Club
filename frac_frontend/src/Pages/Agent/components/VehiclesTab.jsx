                            ...
                            <div key={vehicle.id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition duration-200">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex gap-2">
                                        <Link 
                                            to={`/vehicle/edit/${vehicle.id}`}
                                            className="flex-1 px-3 py-2 bg-teal-600 text-white text-sm rounded-lg hover:bg-teal-700 text-center transition-colors"
                                        >
                                            Edit
                                        </Link>
                                        <button 
                                            onClick={() => openDeleteModal(vehicle)}
                                            className="flex-1 px-3 py-2 bg-red-100 text-red-600 text-sm rounded-lg hover:bg-red-200 transition-colors"
                                        >
                                            Delete
                                        </button>
