...
// //                 // Add mock price data (since your vehicle entity doesn't have price)
// //                 const vehiclesWithPrices = response.data.map(vehicle => ({
// //                     ...vehicle,
// //                     pricePerDay: Math.floor(Math.random() * 5000) + 1500, // Random price between 1500-6500
...
// //                                     <span className="text-2xl font-bold text-teal-600">Rs. {vehicle.pricePerDay}</span>
...
// //                                         <span className="text-gray-700">Total for {Math.ceil((new Date(returnDate) - new Date(pickupDate)) / (1000 * 60 * 60 * 24))} days</span>
...
// //                                 <button
// //                                     type="submit"
// //                                     className="flex-1 py-3 bg-gradient-to-r from-teal-600 to-teal-800 text-white font-semibold rounded-lg hover:from-teal-700 hover:to-teal-900 transition duration-200"
// //                                 >
// //                                     Confirm Booking
// //                                 </button>
// //                                 <button
...
// //                                 Dashboard
// //                             </a>
// //                             <a href="/customer/profile" className="px-6 py-2 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-teal-700 transition duration-200">
// //                                 My Profile
// //                             </a>
// //                         </div>
// //                     </div>
...
// //                             Price Range (per day): Rs. {priceRange.min} - Rs. {priceRange.max}
// //                         </label>
// //                         <div className="flex gap-4">
// //                             <input
// //                                 type="range"
...
// // export default CustomerVehicleViewPage;
...
//                     ...vehicle,
//                     pricePerDay: vehicle.dailyRentalPrice || Math.floor(Math.random() * 5000) + 1500, // Fallback if not present
...
//                                     <span className="text-gray-500 ml-1">/day</span>
//                                 </div>
//                                 <p className="text-sm text-gray-500 mt-1">Agent: {vehicle.agentId ? `Agent #${vehicle.agentId}` : 'Fair Rent A Car'}</p>
//                             </div>
//                         </div>
...
//                                     </div>
//                                     <p className="text-xs text-gray-500 mt-2">Daily rate: {formatCurrency(vehicle.pricePerDay)}</p>
//                                 </div>
//                             )}
                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex gap-4">
                            {isAuthenticated ? (
                                <>
                                    <a href="/customer/vehicleview" className="px-6 py-2 bg-white text-teal-700 font-semibold rounded-lg hover:bg-teal-50 transition duration-200">
                                        Dashboard
                                    </a>
