...
// //             if (!isAvailable) {
// //                 setBookingError('Sorry, this vehicle is no longer available for the selected dates.');
...
// //                         setBookingError(error.response.data?.errorMessage || 'Invalid booking data');
// //                     } else if (error.response.status === 409) {
// //                         setBookingError('Vehicle already booked for these dates');
...
// //                                     }`}
// //                                 >
// //                                     {isSubmitting ? 'Processing...' : isCheckingAvailability ? 'Checking Availability...' : 'Confirm Booking'}
// //                                 </button>
// //                                 <button
// //                                     type="button"
// //                                     onClick={onClose}
...
// //                         </svg>
// //                         {showDateFilter ? 'Hide Date Filter' : 'Filter by Availability Date (click here)'}
...
// //                                             className="p-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition duration-200"
// //                                             title="View Details"
// //                                         >
...
import AIVehicleRecommendation from './components/AIVehicleRecommendation';
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
                ...
                <div className="mb-6 flex justify-between items-center flex-wrap gap-4">
                    ...
                    <button
                        ...
                        className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-700 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-800 transition duration-200 flex items-center gap-2 shadow-lg whitespace-nowrap"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
