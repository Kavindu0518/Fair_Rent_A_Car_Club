...
// // //                                     </a>
// // //                                     {/* Add Profile Link */}
// // //                                     {/* <a href="/customer/profile/edit" className="px-6 py-2 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition duration-200">
// // //                                         Edit Profile
// // //                                     </a> */}
...
// //                             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
// //                         </svg>
// //                         {showDateFilter ? 'Hide Date Filter' : 'Filter by Availability Date (click heir)'}
// //                         {pickupDate && dropOffDate && (
// //                             <span className="ml-2 bg-teal-100 text-teal-800 text-xs px-2 py-1 rounded-full">
// //                                 {new Date(pickupDate).toLocaleDateString()} - {new Date(dropOffDate).toLocaleDateString()}
// //                             </span>
