...
// // //                             <p className="text-gray-600">Find your perfect vehicle by date, location, and preferences</p>
// // //                         </div>
// // //                         <div className="text-center">
...
// //     useEffect(() => {
// //         applyFilters();
// //     }, [searchTerm, fuelTypeFilter, transmissionFilter, seatingCapacityFilter, vehicles]);
...
// //         // Show login prompt
// //         const confirmLogin = window.confirm('Please login to book a vehicle. Would you like to go to the login page?');
// //         if (confirmLogin) {
