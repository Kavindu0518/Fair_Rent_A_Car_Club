...
// //             const response = await axios.post('http://localhost:8080/api/v1/vehicle/add', submitData, {
// //                 headers: {
...
// //                     } else if (errorData && typeof errorData === 'string' && errorData.includes("registration number")) {
// //                         setErrorMessage('Vehicle with this registration number already exists.');
// //                     } else if (errorData && typeof errorData === 'string' && errorData.includes("Invalid fuel type")) {
// //                         setErrorMessage('Invalid fuel type selected.');
// //                     } else if (errorData && typeof errorData === 'string' && errorData.includes("Invalid transmission type")) {
...
// //                         {/* Dashboard Link */}
// //                         <div className="mt-8">
// //                             <a href="/agent/dashboard" className="block w-full py-3 px-6 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-teal-700 transition duration-200 transform hover:-translate-y-1 shadow-lg text-center">
// //                                 Back to Dashboard
// //                             </a>
// //                         </div>
// //                     </div>
...
// //                                 Want to see your vehicles? <a href="/agent/dashboard/vehicles" className="text-teal-600 hover:text-teal-800 font-medium">View Vehicle List</a>
// //                             </p>
...
//         submitData.append('transmissionType', formData.transmissionType);
//         submitData.append('vehicleImage', vehicleImage);
//         submitData.append('agentId', agentId); // ✅ Add agent ID from localStorage
...
//                 // Auto redirect after 3 seconds
//                 setTimeout(() => {
//                     navigate('/agent/dashboard?tab=vehicles'); // Redirect to vehicles tab
//                 }, 3000);
//             }
//         } catch (error) {
//             console.error('Registration error details:', error);
